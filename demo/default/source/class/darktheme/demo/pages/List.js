 ...
 * List
 * 
 * @asset(darktheme/demo/people.json)
 *
 */

qx.Class.define("darktheme.demo.pages.List",
{
  ...
  construct: function()
  {
    ...
    this.__listUrl = qx.util.ResourceManager.getInstance().toUri("darktheme/demo/people.json");
